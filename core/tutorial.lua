local function marcarTutoialComleto()
    local config = cargarSistema()
    config.tutorial_comleted = true
end
...
paso("el proyecto es de código abierto y por el monento solo se encarga una persona únicamente y la persona que se encarga de todo el proyecto es David Fernandez y ese soy yo si el creador de cocos os y en reddit es u/daviddandadan y no, yo no estoy loco, bueno pero por el monento")
