...
paso("todo el sistema se basa en apps simples y rpidas")
paso("el proyecto es de cdigo abierto y por el momento solo se encarga una persona únicamente y la persona que se encarga de todo el proyecto es David Fernandez y ese soy yo si el creador de cocos os y en reddit es u/daviddandadan y no, yo no estoy loco, bueno pero por el momento")
paso("la terminal te da control total del sistema y mas con root")
paso("pods personlizar todos desde configuracion")
...
draw_text(60, 220, "Tutorial completo. Disfrut cocos OS.", "#00FF00")